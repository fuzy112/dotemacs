  ...
  (defun +custom-faces (&optional theme)
    (unless (eq theme 'user)
      ...
      (let ((c '((class color) (min-colors 256))))
        (custom-set-faces
         `(fill-column-indicator ((,c :height 1.0 :foreground ,(face-background 'shadow) :background unspecified)))
         `(parenthesis ((,c :foreground ,(face-foreground 'shadow))))
         `(mode-line-active ((,c :background ,(face-background 'default) :overline ,(face-foreground 'default)
                                 :box (:line-width 6 :color ,(face-background 'default) :style nil))))
         `(mode-line-inactive ((,c :background ,(face-background 'default) :overline ,(face-foreground 'shadow)
                                   :box (:line-width 6 :color ,(face-background 'default) :style nil))))))))
