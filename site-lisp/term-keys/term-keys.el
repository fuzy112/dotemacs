...
(defcustom term-keys/mapping
  ...
  '(["<escape>"		"Escape"	1	"Esc"		#x001B	nil		nil		"ESCAPE"	"Escape"	nil	nil	#x001b	"Escape"	nil	"escape"	]
    ...
    ["`"		"grave"		43	"`"		?`	"~"		"asciitilde"	"GRAVE_ACCENT"	"`"		"~"	?~	nil	"`"		"~"	"`"		]
    ...
    ["'"		"apostrophe"	40	"'"		?'	"\""		"quotedbl"	"APOSTROPHE"	"'"		"\""	?\"	nil	"'"		"\\\""	"'"		]
    ...
    ["<menu>"		"Menu"		127	"Menu"		#x0010	nil		nil		"MENU"		"ContextMenu"  	nil	nil	nil	"Applications"	nil	"menu"		]
