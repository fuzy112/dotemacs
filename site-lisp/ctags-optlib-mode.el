...
;; https://github.com/universal-ctags/universal-ctags.git.
...
(defun ctags-optlib-mode-setup-function ()
  "Setup syntax table for `ctags-optlib-mode'."
  (let ((st (syntax-table)))
...
;;;###autoload(add-to-list 'auto-mode-alist '("\\.ctags\\'" . ctags-optlib-mode))

(provide 'ctags-optlib-mode)
;;; ctags-optlib-mode.el ends here
