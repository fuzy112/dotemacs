...
(defvar nerd-icons-extension-icon-alist
  '(
    ...
    ("deb"            nerd-icons-devicon "nf-dev-debian"         :face nerd-icons-dsilver)
    ...
    ("bzip2"          nerd-icons-octicon "nf-oct-file_binary"    :face nerd-icons-lmaroon)
    ...
    ;; diff and patch
    ("diff"           nerd-icons-octicon "nf-oct-file_diff"      :face nerd-icons-lblue)
    ("patch"           nerd-icons-octicon "nf-oct-file_diff"      :face nerd-icons-lblue)))
...
(defvar                        nerd-icons-regexp-icon-alist
  '(
    ...
    ;; Denote
    ("^[[:digit:]]\\{8\\}T[[:digit:]]\\{6\\}--.*__.*" nerd-icons-mdicon "nf-md-note"    :face nerd-icons-yellow)
...
(defvar nerd-icons-dir-icon-alist
  '(
    ...
    ("onedrive"         nerd-icons-mdicon "nf-md-microsoft_onedrive")
    ...
    ("videos"           nerd-icons-octicon "nf-oct-video")
    ("mail\\'"          nerd-icons-octicon "nf-oct-mail")
    ("devel\\'"         nerd-icons-octicon "nf-oct-code")
    ...
    ("debian\\'"        nerd-icons-devicon "nf-dev-debian")
